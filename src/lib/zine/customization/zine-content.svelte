...
<div class="w-full md:w-auto md:aspect-[1/1.4142] pt-8 pr-4 pb-12 mst">
	<article id="zine" class="prose prose-neutral dark:prose-invert prose-sm md:prose-base lg:prose-lg font-sans mst
