...
const Getting_started = (0, import_index_e1b49292.c)(($$result, $$props, $$bindings, slots) => {
  return `${(0, import_index_e1b49292.v)(import_default_layout_279951cd.D, "Layout_MDSVEX_DEFAULT").$$render($$result, Object.assign($$props, metadata), {}, {
    default: () => {
      return `<p>A static site template that enhances your Markdown with widgets to provide a dynamic PDF-like experience online.</p>`;
    }
  })}`;
});
