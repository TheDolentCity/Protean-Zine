...
<pre class="${"language-javascript"}"><!-- HTML_TAG_START -->${`<code class="language-javascript"><span class="token keyword">import</span> ReadingTime <span class="token keyword">from</span> <span class="token string">'$lib/components/reading-time.svelte'</span><span class="token punctuation">;</span></code>`}<!-- HTML_TAG_END --></pre>
